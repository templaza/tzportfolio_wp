...
//            die('Loader Setup');
            if ($enableClasses)
            {
                ...
                spl_autoload_register(array('tp\lib\Loader', 'load'));
            }
...
//                self::registerPrefix('J', JPATH_PLATFORM . '/joomla');
                ...
                spl_autoload_register(array('tp\lib\Loader', '_autoload'));
            }

            if ($enablePsr)
            {
                // Register the PSR based autoloader.
                spl_autoload_register(array('tp\lib\Loader', 'loadByPsr0'));
                spl_autoload_register(array('tp\lib\Loader', 'loadByPsr4'));
                spl_autoload_register(array('tp\lib\Loader', 'loadByAlias'));
            }
        }
