...
if ( ! class_exists( 'tp\lib\Form\Form' ) ) {
    /**
    ...
    class Form
    {
        ...
        /**
         * Text domain for multiple languages.
         *
         * @var    boolean
         */
     ...
     */
        ...
        public function validate($data, $group = null)
        {
            ...
            foreach ($fields as $field)
            {
                ...
                {
                    throw new \RuntimeException(TPLanguage::sprintf('JLIB_FORM_VALIDATE_FIELD_INVALID', $name));
                }
