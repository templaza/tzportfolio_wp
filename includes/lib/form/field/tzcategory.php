...
if ( ! class_exists( 'tp\lib\Form\Field\TZCategoryField' ) ) {
    /**
     ...
     * @since  11.1
     */
    class TZCategoryField extends ListField
    {
        /**
         * The form field type.
         *
        ...
        protected function getOptions()
        {
            ...
            if (!empty($extension)) {
                ...
                $options = HTMLHelper::_('tzcategory.options', $extension, $config);
...
//                \Log::add(JText::_('JLIB_FORM_ERROR_FIELDS_CATEGORY_ERROR_EXTENSION_EMPTY'), JLog::WARNING, 'jerror');
            }
