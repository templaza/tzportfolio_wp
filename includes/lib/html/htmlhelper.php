...
use tp\lib\Layout\LayoutHelper;
...
if ( ! class_exists( 'tp\lib\HTML\HTMLHelper' ) ) {
    /**
    ...
    abstract class HTMLHelper
    {
        ...
        protected static function extract($key)
        {
            ...
            $prefix = count($parts) === 3 ? array_shift($parts) : 'TPHtml';
        ...
        public static function _($key)
        {
            ...
            if(!class_exists($className) && __NAMESPACE__){
            ...
            if (!class_exists($className))
            {
                ...
                Loader::register($className, $path);
