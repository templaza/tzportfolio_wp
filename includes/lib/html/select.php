...
if(!class_exists('tp\lib\HTML\TPHtmlSelect')){
    /**
     * Utility class for creating HTML select lists
     *
     */
    abstract class TPHtmlSelect
    {
        /**
        ...
        {
            $arr = array(HTMLHelper::_('select.option', '0', JText::_($no)), HTMLHelper::_('select.option', '1', JText::_($yes)));
