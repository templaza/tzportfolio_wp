...
use tp\lib\Layout\BaseLayout;

if ( ! class_exists( 'tp\lib\Layout\FileLayout' ) ) {
...
//            $this->setClient($this->options->get('client', 'auto'));
        ...
        {
            Loader::import('joomla.filesystem.path');
...
//            $paths[] = JPATH_ROOT . '/layouts';
            ...
            $paths[]    = TP_PLUGIN_LIBRARY_PATH.'/form/field/html';
